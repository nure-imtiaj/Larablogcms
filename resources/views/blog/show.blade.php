  ...
  <div class="container text-center">
    ...
    <div class="row h-100">
      <div class="col-lg-8 mx-auto align-self-center">
        ...
        <p><img class="avatar avatar-sm" src="{{ Gravatar::src($post->image) }}" alt="..."></p>
...
<main class="main-content">
  ...
  <div class="section" id="section-content">
    <div class="container">
        ...
        <!-- end of www.addthis.com/dashboard to customize your tools -->
...
s.src = 'https://imtiaj-blog.disqus.com/embed.js';
